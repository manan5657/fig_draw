...
const client = createClient({
  publicApiKey: process.env.NEXT_PUBLIC_LIVEBLOCKS_PUBLIC_KEY!, //! Exclamation mark is for telling (TS) that we are not sure that this variable is present or not
